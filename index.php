...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2>Hangloo Car rental company</span></h2>
      <p><h4>Find the Best Car For You</h4><br>
You're better off driving our way.</p>
    </div>
    <div class="row"> 
  ...
  <div class="container div_zindex">
    <div class="row">
      ...
      <div class="col-lg-3 col-xs-6 col-sm-3">
        <div class="fun-facts-m">
          <div class="cell">
            <h2><i class="fa fa-car" aria-hidden="true"></i>4000+</h2>
...
<section class="section-padding testimonial-section parallex-bg">
  <div class="container div_zindex">
    <div class="section-header white-text text-center">
      <h2>Your Satisfaction <span>is our Goal</span></h2>
    </div>
    <div class="row">
...
{  ?>
        ...
        <div class="testimonial-m">
          <div class="testimonial-img"> <img src="assets/images/user.png" alt="" /> </div>
